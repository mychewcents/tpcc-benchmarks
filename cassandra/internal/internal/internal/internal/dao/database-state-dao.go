...
type DatabaseStateDao interface {
	...
	GetOrderLineState() (sumOlAmount float32, sumOlQuantity int64)
...
func (d *databaseStateDaoImpl) GetOrderState() (maxOId gocql.UUID, sumOOlCnt int64) {
	...
	if err != nil {
		log.Printf("ERROR GetOrderState err=%v\n", err)
		return
	}
	return
}

func (d *databaseStateDaoImpl) GetOrderLineState() (sumOlAmount float32, sumOlQuantity int64) {
	...
	if err != nil {
		log.Printf("ERROR GetOrderLineState err=%v\n", err)
		return
	}
	return
}
